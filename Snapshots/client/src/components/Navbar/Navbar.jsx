...
const Navbar = () => {
  ...
  return (
    <header>
      <nav className="flex justify-around items-center p-4 shadow-md bg-[#393E46] text-white font-medium max-lg:hidden">
              ...
              <div className="relative group" onClick={toggleProfileModal}>
                <div className="group cursor-pointer">
                  <img
                    ...
                    className="w-12 h-12 rounded-full border-2 border-white mr-2 group-hover:opacity-75 transition-opacity"
                  />
                </div>
                {isProfileModalOpen && (
                  <>
      ...
      <nav className="p-4 shadow-md bg-[#393E46] text-white font-medium lg:hidden">
