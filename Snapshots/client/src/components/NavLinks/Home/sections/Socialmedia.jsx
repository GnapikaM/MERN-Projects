  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center max-lg:flex-col max-sm:-mt-16">
      <div className="bg-white p-8 rounded-md shadow-md h-[400px] max-sm:h-full m-4 w-full md:w-2/3 lg:w-1/2 max-sm:p-2">
        ...
        <div className="flex mt-2 justify-center items-center max-sm:flex-col">
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline-blue max-sm:mb-2">
            Share on Facebook
          </button>
          <button className="ml-2 bg-blue-400 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline-blue max-sm:ml-0">
            Share on Twitter
          </button>
        </div>
