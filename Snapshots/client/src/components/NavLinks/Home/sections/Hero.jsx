...
const Hero = () => {
  return (
    <div className="mx-auto text-center py-56 relative w-full h-full mb-10 max-lg:pb-24">
      <div className="bg-hero bg-cover h-full w-full absolute top-0 left-0 max-lg:top-0"></div>
      <div className="bg-hero-before bg-cover h-full w-full absolute top-0 left-0 opacity-50 max-lg:top-0"></div>
