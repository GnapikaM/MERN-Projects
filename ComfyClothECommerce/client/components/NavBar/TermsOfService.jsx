    ...
    <div className="container mx-auto px-4 pb-8 pt-32 max-[550px]:pt-40 max-sm:mx-2">
      ...
      <div className="prose">
        ...
        <p style={{color: `var(--gray-color)`}}>
          Welcome to ComfyStore. These Terms of Service govern your use of our website, located
          at <a href="" className="underline">https://gnapikam-comfycloth.netlify.app/</a>, and any related services provided by us.
        </p>
        ...
        <p style={{color: `var(--gray-color)`}}>
          ...
          and will remain the exclusive property of ComfyStore and its
        ...
        <div className="pt-6 flex items-center">
          ...
          <span className="flex items-center mb-2 pl-2" style={{color: `var(--gray-color)`}}>
